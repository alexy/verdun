...
const migrationPath = optionValue('--migration') ?? process.env.NEWSLETTER_MIGRATION_FILE ?? 'db/migrations/0001_newsletter.sql'
...
assertFile(migrationPath, 'migration file')
