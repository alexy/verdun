...
- The Rust crawler now has a Garbage instance module for snapshot/domain structs, normalization, dedupe, and project-count aggregation, but fetch adapters and most Garbage-specific collection behavior still live in `crawler/src/main.rs`.
