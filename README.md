...
- Garbage-specific ontology and newsletter logic live in the parent package under `apps/garbage/src/`; resident Verdun UI/API compatibility code imports those modules while the UI boundary is still bundled.
