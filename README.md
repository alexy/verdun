...
- Publishing readiness checks show whether the queue has explicit editorial picks, live source coverage, project spread, saved focus, and healthy watched sources before local Ulysses export.
