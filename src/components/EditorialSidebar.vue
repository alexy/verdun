...
import type { NewsItem, NewsletterFocus, NewsletterReadiness, SourceRun } from '../lib/newsletter'
...
<template>
  <aside class="briefing">
    ...
    <SourceHealthPanel :pending-source-count="pendingSourceCount" :source-runs="sourceRuns" />
