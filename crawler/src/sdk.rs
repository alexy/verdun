...
pub use crate::core::{
    ...
    CrawlerSnapshot, EditorialFocus, NormalizedCollectionPlan, NormalizedRecord, ReviewTarget,
    SourceConfig, SourceRun, SourceRunStatus, SourceRunSummary, slug, stable_id,
};
