...
- Replace the parent Garbage package's remaining bundled Verdun runtime/data assumptions with package-owned runtime and data boundaries one command group at a time.
