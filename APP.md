...
- Static fallback data in `public/data/newsletter-items.json`, regenerated by the Rust crawler.
- Live public-source ingestion for Hacker News and Lobste.rs, merged with the curated watchlist for Pydantic, LakeSail, Turso, LanceDB, HelixDB, SurrealDB, pgGraph, Grust, and TypeSec.
