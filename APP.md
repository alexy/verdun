...
- Greathouse-style dashboard components extracted under `src/components/`, including `AppHeader.vue` and `SourceHealthPanel.vue`, so shared shell/source-health UI can be generalized later.
