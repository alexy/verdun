...
- Live public-source ingestion for Hacker News, Lobste.rs, dev.to, and configured Medium/Substack feeds, merged with the curated watchlist for Pydantic, LakeSail, Turso, LanceDB, HelixDB, SurrealDB, pgGraph, Grust, and TypeSec.
