...
- The bundled Garbage API store and workbench adapter import `apps/garbage/src/config.ts`, while retaining legacy static/local state fallback paths only for the current bundled runtime.
